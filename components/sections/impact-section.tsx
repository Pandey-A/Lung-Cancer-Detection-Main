...
export function ImpactSection() {
  return (
    <section id="how-we-work" className="px-6 py-24 bg-zinc-900/20">
      <div className="max-w-5xl mx-auto">
        {/* Impact Section Header */}
        <div className="text-center mb-12">
          <p className="text-sm font-medium text-zinc-500 uppercase tracking-wider mb-4">How We Work</p>
          <h2 className="font-display text-3xl md:text-4xl font-bold text-zinc-100 mb-4">From CT signal to patient-ready report</h2>
          <p className="text-zinc-500 max-w-lg mx-auto text-balance">
            Radiologists upload scan references, review AI prediction, edit the report, and deliver clear next-step advice.
          </p>
        </div>
