...
export function FeaturesSection() {
  return (
    <section id="functionality" className="px-6 py-24">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <p className="text-sm font-medium text-zinc-500 uppercase tracking-wider mb-4">Functionality</p>
          <h2 className="font-display text-3xl md:text-4xl font-bold text-zinc-100 mb-4">
            Everything needed for AI-assisted lung report workflows
          </h2>
          <p className="text-zinc-500 max-w-xl mx-auto text-balance">
            Prediction, reporting, editing, sharing, and follow-up support in one clinical flow.
          </p>
        </motion.div>
